    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkCalendarAccount(MainActivity.this)==-1){
                    addCalendarAccount(MainActivity.this);
                }
                checkCalendarAccount(MainActivity.this);
                System.out.println(checkCalendarAccount(MainActivity.this));
                if (checkCalendarAccount(MainActivity.this)>0){
                    Calendar mCalendar=Calendar.getInstance();
                    mCalendar.set(2017,0,ClickedDay,ClickedHour,ClickedMinute);
                    long start = mCalendar.getTime().getTime();
                    addCalendarEvent(MainActivity.this,getString(R.string.title),getString(R.string.description),start);
